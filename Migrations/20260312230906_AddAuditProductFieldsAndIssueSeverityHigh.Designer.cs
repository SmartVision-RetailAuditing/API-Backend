...
namespace ApiBackend.Migrations
{
    ...
    [Migration("20260312230906_AddAuditProductFieldsAndIssueSeverityHigh")]
    partial class AddAuditProductFieldsAndIssueSeverityHigh
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiBackend.Entities.AuditProduct", b =>
                {
                    ...
                    b.Property<bool>("IsEyeLevel")
                        .HasColumnType("boolean")
                        .HasColumnName("is_eye_level");
            ...
            modelBuilder.Entity("ApiBackend.Entities.AuditIssue", b =>
                {
                    b.HasOne("ApiBackend.Entities.Audit", "Audit")
                        .WithMany("Issues")
